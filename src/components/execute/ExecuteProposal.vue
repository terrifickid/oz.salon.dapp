  ...
  <div v-if="loaded">
    ...
    <div v-else-if="type == 'kick' && passed && hasEnded">
      ...
      <div class="mb-32 text-xs" v-if="exec">
        ...
        <p class="mb-2">
          ...
          majority of members voted to kick NAME on DATE KICK PROPOSAL ENDED at
          TIME KICK PROPOSAL ENDED.
        </p>

        <p class="mb-2">
          The book value of Salon units on DATE at TIME was $PRICE per unit. At
          that time, NAME'S units were valued at $VALUE OF NAME'S UNITS AT BOOK
          VALUE AT TIME KICK PROPOSAL ENDED.
        </p>
    ...
    <div class="mb-32" v-else-if="hasEnded && passed && ownsProposal">
      <div v-if="exec" class="text-xs">
        ...
        <p class="mb-2">
          You sent {{ format.format(amount) }} to Salon's treasury in exchange
          for {{ units }} units.
        </p>
                  ...
                  <table class="text-sm w-full">
                    ...
                    <tr>
                      ...
                      <td valign="top">
                        ...
                        Trust (Including this exact memo in Line 72 is critical
                        to properly receive funds)
                      </td>
                    </tr>
...
export default {
  ...
  computed: {
    id() {
      return _.get(this.proposal, "sys.id");
    },
    type() {
