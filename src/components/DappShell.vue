<template>
  <div style="background: #d54a37">
    <template v-if="!userAddress">
      <div
        class="flex min-w-full relative min-h-screen text-electric relative items-center justify-center p-3"
      >
        <template v-if="!connecting">
          ...
          <div>
            <button
              @click="connect"
              class="flex items-center px-6 py-4 text-2xl md:text-3xl ml-3 text-lg hover:bg-electric border-2 border-electric rounded-full"
            >
              <svg
          ...
          <svg
            class="absolute right-3 bottom-3 fill-electric"
            version="1.1"
            id="Layer_1"
            xmlns="http://www.w3.org/2000/svg"
            ...
            style="enable-background: new 0 0 5368 1509; width: 30vw"
            xml:space="preserve"
          >
            <path
              class="fill-electric"
